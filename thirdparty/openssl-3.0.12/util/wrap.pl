...
BEGIN {
    ...
    require 'D:/apps/filefile/thirdparty/openssl-3.0.12/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = 'D:/apps/filefile/thirdparty/openssl-3.0.12/test/fips-and-base.cnf';
    shift;
